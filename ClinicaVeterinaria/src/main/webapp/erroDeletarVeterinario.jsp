...
<title>Erro - Deletar Veterinário</title>
<link
...
<body>
	...
	<div class="container text-center mt-5">
		<h3 class="text-danger">Erro ao deletar o Veterinário!</h3>
		<p class="lead">Por favor, verifique se o Veterinário existe e não
			possue nenhum animal vinculado em atendimento!</p>
		<a href="/ClinicaVeterinaria/VeterinariosController?opcao=listVet">Listar
			Veterinários</a>
	</div>
</body>
</html>
