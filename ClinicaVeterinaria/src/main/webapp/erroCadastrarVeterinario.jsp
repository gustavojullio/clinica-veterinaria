...
<title>Erro - Cadastrar Veterinário</title>
<link
...
<body>
	...
	<div class="container text-center mt-5">
		<h3 class="text-danger">Erro ao Cadastrar o Veterinário!</h3>
		<p class="lead">Por favor, tente novamente!</p>
		<p style="text-align: center">
			<a href="/ClinicaVeterinaria/VeterinariosController?opcao=retornar">Menu
				Inicial</i>
			</a>
		</p>
	</div>
