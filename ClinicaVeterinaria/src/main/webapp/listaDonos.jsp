					...
					<c:forEach items="${donos}" var="dono">
						<div class="row border rounded-1 my-2">
							...
							<div class="col-5 col-lg-3">
								<p class="text-center">
									<a
										href="/ClinicaVeterinaria/DonosController?opcao=consultar&id=${dono.id}"><i
										class="bi bi-eye-fill operation"></i></a> <a
										href="/ClinicaVeterinaria/DonosController?opcao=editar&id=${dono.id}"><i
										class="bi bi-pencil-square operation"></i></a> <a
										href="/ClinicaVeterinaria/DonosController?opcao=deletar&id=${dono.id}"><i
