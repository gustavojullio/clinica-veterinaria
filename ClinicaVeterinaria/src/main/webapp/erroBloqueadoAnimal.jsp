...
<title>Erro - Editar Animal - Acesso negado</title>
<link
...
<body>
	...
	<div class="container text-center mt-5">
		<h3 class="text-danger">Erro ao editar ou excluir o Animal!</h3>
		<h3 class="text-danger">Você só pode editar ou excluir o animal
			que você ATENDE!</h3>
		<a href="/ClinicaVeterinaria/AnimaisController?opcao=listAni">Listar
			Animais</a>
	</div>
</body>
</html>
