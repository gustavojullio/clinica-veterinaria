...
<title>Erro - Editar Veterinário</title>
<link
...
<body>
	...
	<div class="container text-center mt-5">
		<h3 class="text-danger">Erro ao editar o Veterinário!</h3>
		<p class="lead">Por favor, verifique se o Veterinário existe e os
			dados estão corretos!</p>
