				...
				<form class="row g-3" method="post"
					...
					<div class="col-4">
						<label for="idade" class="form-label">Idade</label> <input
							...
							value="${veterinario.idade}" required />
					</div>

					<div class="col-8">
						<label for="telefone" class="form-label">Telefone</label> <input
							type="number" class="form-control" name="telefone" size="60"
							value="${veterinario.telefone}" required />
					</div>


					<div class="col-6">
						<label for="usuario" class="form-label">Usuário</label> <input
							type="text" class="form-control" name="usuario" size="60"
							value="${veterinario.usuario}" required />
					</div>

					<div class="col-6">
						<label for="senha" class="form-label">Senha</label> <input
							type="password" class="form-control" name="senha" size="60"
							value="${veterinario.senha}" required />
					</div>

					<div class="col-12">
						<a href="/ClinicaVeterinaria/VeterinariosController?opcao=listVet"><button
								type="button" class="btn btn-danger">Voltar</button></a> <input
