		...
		<c:when test="${autenticado}">
			...
			<div class="container">
				...
				<form class="row g-3" method="post"
					action="/ClinicaVeterinaria/DonosController">
					<div class="col-12">
						<label for="nome" class="form-label">Nome</label> <input
							type="text" class="form-control" name="nome" size="60" required />
					</div>

					<div class="col-4">
						<label for="idade" class="form-label">Idade</label> <input
							type="number" class="form-control" name="idade" size="30"
							required />
					</div>

					<div class="col-8">
						<label for="cpf" class="form-label">CPF</label> <input
							type="number" class="form-control" name="cpf" size="30" required />
					</div>

					<div class="col-8">
						<label for="endereco" class="form-label">Endereço</label> <input
							type="text" class="form-control" name="endereco" size="60"
							required />
					</div>

					<div class="col-4">
						<label for="telefone" class="form-label">Telefone</label> <input
							type="number" class="form-control" name="telefone" size="60"
							required />
					</div>
					...
					<div class="col-12">
						<a
							href="/ClinicaVeterinaria/VeterinariosController?opcao=retornar"><button
								type="button" class="btn btn-secondary">Cancelar</button></a> <input
							type="submit" name="opcao" value="Cadastrar"
