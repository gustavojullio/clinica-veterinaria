				...
				<form class="row g-3" method="post"
					...
					<div class="col-4">
						<label for="raca" class="form-label">Raça</label> <input
							type="text" class="form-control" name="raca" size="60" required />
					</div>

					<div class="col-4">
						<label for="peso" class="form-label">Peso</label> <input
							type="number" class="form-control" name="peso" size="60" required />
					</div>
					...
					<div class="col-6">
						<label for="id_dono" class="form-label">Dono</label> <select
							name="id_dono" class="form-select">
