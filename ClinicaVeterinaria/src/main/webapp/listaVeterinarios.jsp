...
<title>Lista - Veterinários</title>
<link
				...
				<div class="container mt-3">
					...
					<c:forEach items="${veterinarios}" var="veterinario">
						<div class="row border rounded-1 my-2">
							...
							<div class="col-5 col-lg-3">
								<p class="text-center">
									<a
										href="/ClinicaVeterinaria/VeterinariosController?opcao=consultar&id=${veterinario.id}"><i
										class="bi bi-eye-fill operation"></i></a> <a
										href="/ClinicaVeterinaria/VeterinariosController?opcao=editar&id=${veterinario.id}"><i
										class="bi bi-pencil-square operation"></i></a> <a
										href="/ClinicaVeterinaria/VeterinariosController?opcao=deletar&id=${veterinario.id}"><i
										class="bi bi-trash3-fill operation"></i></a>
								</p>
							</div>
						</div>
					</c:forEach>
					...
					<p style="text-align: center">
						<button type="button" class="btn btn-menu">
							<a
								href="/ClinicaVeterinaria/VeterinariosController?opcao=retornar">Menu
								Inicial</i>
							</a>
						</button>
					</p>
