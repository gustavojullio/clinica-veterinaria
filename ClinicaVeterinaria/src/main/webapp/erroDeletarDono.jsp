...
<body>
	...
	<div class="container text-center mt-5">
		<h3 class="text-danger">Erro ao deletar o Dono!</h3>
		<p class="lead">Por favor, verifique se o Dono existe e não possue
			nenhum animal vinculado em atendimento!</p>
		<a href="/ClinicaVeterinaria/DonosController?opcao=listDon">Listar
			Donos</a>
	</div>
</body>
</html>
